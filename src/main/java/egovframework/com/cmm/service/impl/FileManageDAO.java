...
public class FileManageDAO extends EgovComAbstractDAO {
	 ...
	 * @throws Exception
	 */
	public void updateFileDetail(List<?> fileList) throws Exception {
		FileVO vo;
		Iterator<?> iter = fileList.iterator();
		while (iter.hasNext()) {
			vo = (FileVO) iter.next();
	...
	/**
	 * 하나의 파일을 삭제한다. > 게시판 테이블 파일명 삭제
	 *
	 * @param fvo
	 * @throws Exception
	 */
	public void deleteBoardInf(FileVO fvo) throws Exception {
		delete("FileManageDAO.deleteBoardInf", fvo);
	}
