...
public class EgovFileMngController {
    ...
    public String selectFileInfs(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		...
		if("03".equals(boardCode) || "04".equals(boardCode) || "06".equals(boardCode) || "07".equals(boardCode)){
			resultUrl = "common/fileListNotDel";
		}else{
			resultUrl = "common/fileList";
		}
		return resultUrl;
    }
    ...
    public String deleteFileInf(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam("returnUrl") String returnUrl, /*SessionVO sessionVO,*/ HttpServletRequest request, ModelMap model) throws Exception {
