...
%>
		...
		<script type="text/javascript">
			...
			function info_agree(v_type){
				...
				if(v_type == "insert"){
					document.frm.action = "<c:url value='/admin/homep/info_join.do'/>";
				}else{
					document.frm.action = "<c:url value='/admin/homep/info_update.do'/>";
				}
				document.frm.submit();
			}
	                ...
	                <fieldset>
	                    ...
	                    <div class="defbtn-wrap">
	                    	<%if(s_type.equals("update")){ %>
		                        <button type="button" class="defbtn pink" onclick="javascript:info_agree('update')">수정</button>
		                        <button type="button" class="defbtn white" onclick="javascript:info_delete();">삭제</button>
	                        <%}else{ %>
		                        <button type="button" class="defbtn pink" onclick="javascript:info_agree('insert')">등록</button>
