...
<%@ taglib  prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
		...
		<script type="text/javascript">
			...
			function popupListGo(pageNo) {
				document.frm.pageIndex.value = pageNo;
				//$("#pageIndex").val(pageNo);
				document.frm.action = "<c:url value='/admin/homep/homep_popup_list.do'/>";
				document.frm.submit();
			}
		</script>
		...
		<div class="container" id="container">
			...
			<div class="contents">
	            ...
	            <table class="tbl image">
	                ...
	                <tbody class="tc">
						<c:forEach var="result" items="${resultList}" varStatus="status">
			                <tr>
		                        <td>${result.rownum }</td>
		                        <td><a href="/admin/homep/homep_popup_view.do?popup_no=${result.popup_no }&type=update">${result.title }</a></td>
		                        <td>
	            ...
	            <div class="clearfix">
	                <a href="/admin/homep/homep_popup_view.do?type=insert" class="message form-line-btn defbtn pink fr">등록</a>
	            </div>
	           ...
	           <!--  <div class="tbl-search">
				...
				<form name="frm" action ="<c:url value='/admin/homep/homep_popup_list.do'/>" method="post" enctype="multipart/form-data">
				<input type="hidden" name="pageIndex" value="<c:out value='${boardVO.pageIndex}'/>"/> 
			        ...
			        <div class="tbl-search">
			            ...
			            <button type="button" class="tbl-search-btn" onclick="javascript:popupListGo('1');"><span class="screen_out">검색</span></button>
			        </div>
		        </form>
