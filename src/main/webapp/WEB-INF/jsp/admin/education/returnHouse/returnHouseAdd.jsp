		...
		<script type="text/javascript">
			...
			function returnHouseInsert(){
				...
				$.ajax({
					type : "post",
					cache : false,
					url : "/admin/education/returnHouseInsert.do",
					data: formData,
					async   : false,
					processData: false,
					contentType : false,
				...
				/* document.frm.action = "<c:url value='/admin/education/returnHouseInsert.do'/>";
				document.frm.submit(); */
			}
	            	...
	            	<div class="newfran-firbox sel-author clearfix">
			            <div class="search-box fl sel-basic">
			            	<select name="house_code" id="house_code" class="fl">
						    	<option value="01" >귀농인의 집1</option>
						        <option value="02" >귀농인의 집2</option>
						    </select>
						 </div>
					</div>    
	                <fieldset>
	                    ...
	                    <table class="tbl no-thead write">
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="2"><input type="text" id="education_name" name="education_name" class="form-inputbox" value=""/></td>
	                        </tr>
	                        <tr>
	                            <th><label for="start_date">교육기간</label></th>
	                            <td colspan="2">
	                                <div class="form-input" style="width:45%;float:left;">
	                                    <input type="text" id="education_start" name="education_start" class="form-inputbox white js-datepicker" value="">
	                                </div>
	                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                                <div class="form-input" style="width:45%;float:right;">
	                                    <input type="text" id="education_end" name="education_end" class="form-inputbox white js-datepicker" value="">
	                                </div>
	                            </td>
	                        </tr>
	                        <!-- <tr>
	                    ...
	                    <div class="defbtn-wrap">
	                    	<button type="button" class="defbtn pink" onclick="javascript:returnHouseInsert()">등록</button>
