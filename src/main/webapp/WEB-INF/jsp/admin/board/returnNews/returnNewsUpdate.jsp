...
<script type="text/javascript" src="/admin/js/admin_board_common.js" charset="utf-8"></script>
<%
		...
		<div class="container" id="container">
			<div class="breadcrumb">
			    <ul class="">
			        ...
			        <li class="active">강원 귀농귀촌 뉴스</li>
			    </ul>
			</div>
			<h3 class="subcont-tit">강원 귀농귀촌 뉴스</h3>
			<div class="contents">
				<form name="frm" id="frm" method="post" enctype="multipart/form-data">
			        ...
			        <fieldset>
			            <legend class="screen_out">강원 귀농귀촌 뉴스 수정</legend>
			            <table class="tbl tc no-thead write">
			                <caption>강원 귀농귀촌 뉴스 수정</caption>
			                <colgroup>
			                    <col style="width:25%;"/>
			                    <col style="width:75%;"/>
			                </colgroup>
			                ...
			                <tr>
			                    ...
			                    <td class="tl">
			                    	...
			                    	<input type="hidden" id="writer" name="writer" value="${curAdmin.id}"/>
			                    </td>
			                </tr>
			                <tr>
			              ...
			              <%--  <tr>
			                    ...
			                    <td class="tl">
			                    	<input type="text" id="inp-writer" name="inp-writer" class="form-inputbox" value="${result.ntcrNm}" readonly="readonly"/>
			                    	<a href="#"  onclick="referenceArticleGo('${result.prev_no}','${result.board_code}');">
			                ...
			                <tr>
			                    ...
			                    <td class="tl">
			                    	<input type="text" id="inp-writer" name="inp-writer" class="form-inputbox" value="${result.ntcrNm}" readonly="readonly"/>
			                    	<a href="#"  onclick="referenceArticleGo('${result.next_no}','${result.board_code}');">
