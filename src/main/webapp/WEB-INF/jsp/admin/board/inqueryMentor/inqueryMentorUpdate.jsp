		...
		<div class="container" id="container">
			<div class="breadcrumb">
			    <ul class="">
			        ...
			        <li class="active">멘토에게 물어봐</li>
			    </ul>
			</div>
			<h3 class="subcont-tit">멘토에게 물어봐</h3>
			<div class="contents">
				<form name="frm" id="frm" method="post" enctype="multipart/form-data">
			        ...
			        <fieldset>
			            <legend class="screen_out">멘토에게 물어봐 수정</legend>
			            <table class="tbl tc no-thead write">
			                <caption>멘토에게 물어봐 수정</caption>
			                <colgroup>
			                    <col style="width:25%;"/>
			                    <col style="width:75%;"/>
			                </colgroup>
			            ...
			            <div class="defbtn-wrap">
				        	<%-- <%if(s_bbsId2.equals("BBSMSTR_000000000001")){ %>
          					...
          					<%}else if(s_bbsId2.equals("BBSMSTR`_000000000003")){ %>
