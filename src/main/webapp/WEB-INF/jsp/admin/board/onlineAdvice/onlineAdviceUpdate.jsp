...
%>
		...
		<div class="container" id="container">
			...
			<div class="contents">
			<form name="frmGet" method="post" enctype="multipart/form-data">
				<input type="hidden" id="boardCodeGet" name="boardCode" value="<c:out value='${result.board_code }'/>"/>
				...
				<form name="frm" id="frm" method="post" enctype="multipart/form-data">
			        ...
			        <fieldset>
			            <legend class="screen_out">온라인상담 수정</legend>
			            <table class="tbl tc no-thead write">
			                <caption>온라인상담 수정</caption>
			                <colgroup>
			                    <col style="width:25%;"/>
			                    <col style="width:75%;"/>
			                </colgroup>
