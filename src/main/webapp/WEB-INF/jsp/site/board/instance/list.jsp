        ...
        <div class="basicboard-wrap">
            ...
            <div class="tr">
	            <c:if test="${sessionScope.loginVO.login_type eq 'admin' }">
    	            <a href="javascript:instanceAddGo();" class="commonbtns black onebtn">글쓰기</a>
        		</c:if>
            </div>
            
            <form name="frm" action ="<c:url value='/site/instance/instance.do'/>" method="post" enctype="multipart/form-data">
            ...
            <div class="pgwrap">
	            ...
	            <div class="search-wrap seltwo">
	                <div class="seacharea">
	                    <select name="regionCode" id="regionCode" class="sel-filter" title="검색지역 선택">
