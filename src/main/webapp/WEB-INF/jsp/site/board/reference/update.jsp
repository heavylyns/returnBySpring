                ...
                <fieldset>
                    ...
                    <table class="basicboard-tbl write no-thead">
                        ...
                        <c:if test="${result.attached_file_id ne null}">
	                        <tr>
	                            <th><label for="inp-file">첨부파일 목록</label></th>
	                            <td class="tl">
	                            	<c:import url="/cmm/fms/selectFileInfs.do" charEncoding="utf-8">
										<c:param name="param_atchFileId" value="${result.attached_file_id}" />
										<c:param name="updateFlag" value="Y" />
										<c:param name="returnUrl" value="/site/policy/reference_action.do?type=update&boardNo=${result.board_no}&boardCode=01"/> 
									</c:import>
	                            </td>
	                        </tr>
                        </c:if>
                        <tr>
							...
							<td class="tl">
								<input name="file" id="egovComFileUploader" type="file" title="첨부파일입력" />
							</td>
						</tr>
                        <tr>
                            <td colspan="2">
