...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
		...
		<script type="text/javascript">
			...
			function boardListGo() {
				...
				document.frm.action = "<c:url value='/site/instance/story.do'/>";
				document.frm.submit();
			}
			...
			function boardUpdateGo(){
				document.frm.method = "post";
				document.frm.action = "<c:url value='/site/instance/story_action.do?type=update'/>";
				document.frm.submit();
			}
	...
	<div class="incontainer">
        ...
        <div class="basicboard-wrap">
            ...
            <div class="clearfix tr">
            	<c:if test="${user.id eq result.writer || user.login_type eq 'admin'}">
