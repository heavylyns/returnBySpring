...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<script type="text/javascript">
		...
		function selectArticle(boardNo){
			...
			document.frm.action = "<c:url value='/site/instance/story_view.do'/>";
			document.frm.submit();
		}
		function storyAddGo(){
			document.frm.action = "<c:url value='/site/instance/story_action.do?type=insert'/>";
			document.frm.submit();				
		}
	</script>
	...
	<div class="incontainer">
        <div class="subdepwrap">
            <p class="subdep2-tit">나의 귀농귀촌 이야기</p>
        ...
        <div class="basicboard-wrap">
            ...
            <div class="tr">
            	<c:if test="${sessionScope.loginVO.login_type eq 'admin' }">
                	<a href="javascript:storyAddGo();" class="commonbtns black onebtn">글쓰기</a>
                </c:if>
            </div>
            
            <form name="frm" action ="<c:url value='/site/instance/story.do'/>" method="post" enctype="multipart/form-data">
