...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	<script type="text/javascript">
		...
		function freeBoardAddGo(){
			document.frm.action = "<c:url value='/site/comunity/freeBoard_action.do?type=insert'/>";
			document.frm.submit();				
		}
	</script>
	<div class="incontainer">
        ...
        <div class="basicboard-wrap">
            ...
            <form name="frm" action ="<c:url value='/site/comunity/freeBoard.do'/>" method="post" enctype="multipart/form-data">
