	...
	<script type="text/javascript">
		...
		function regionalEduInsert(){
			...
			$.ajax({
				type : "post",
				cache : false,
				url : "/site/edu/regionalEduInsert.do",
				data: formData,
				async   : false,
				processData: false,
				contentType : false,
	...
	<div class="incontainer">
        ...
        <div class="basicboard-wrap">
            <form id="frm" name="frm" action="" method="post" enctype="multipart/form-data">
            	...
            	<input type="hidden" name="display_yn" id="display_yn"/>
                <fieldset>
                    ...
                    <table class="basicboard-tbl write no-thead">
                        ...
                        <tr>                            
                            ...
                            <td colspan="3" class="tl">
                                <input type="text" id="r_edu_title" name="r_edu_title" class="wid60"/>
                                <div class="incheckwrap">
                                    <input type="checkbox" id="display_check" name="display_check" class="chkbtnjs"/><label for="display_check">선택 시 이달의 교육에 나타납니다.</label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="tl">
                            	<input type="text" id="r_edu_place" name="r_edu_place" class="wid100"/>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><label for="inp-eduperiod">교육기간</label></th>
                            <td class="tl">
                            	<input type="text" id="r_edu_start" name="r_edu_start" class="wid40 js-datepicker" title="기간선택"/> <span style="padding: 0 8px; font-weight: 700;">~</span> 
                            	<input type="text" id="r_edu_end" name="r_edu_end" class="wid40 js-datepicker" title="기간선택"/>
                            </td>
                            <th scope="row"><label for="inp-eduperiod">전화번호</label></th>
                            <td class="tl">
                            	<input type="text" id="r_edu_tel" name="r_edu_tel" class="wid100"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr class="chkhidejs-wrap">
                            ...
                            <td class="tl" colspan="3"><textarea name="r_edu_summary" id="r_edu_summary" cols="30" rows="10" class="wid100"></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="4">
                            	<textarea name="r_edu_contents" id="contents" cols="100" rows="15" class="wid100 inptxt"></textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    <div class="clearfix twobtnwrap tc">
                        <a href="#" class="commonbtns black" onclick="javascript:regionalEduInsert();">등록하기</a>
