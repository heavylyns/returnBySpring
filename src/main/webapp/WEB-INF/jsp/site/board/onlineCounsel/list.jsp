...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	<script type="text/javascript">
		...
		function onlineCounselAddGo(){
			document.frm.action = "<c:url value='/site/counsel/onlineCounsel_action.do?type=insert'/>";
			document.frm.submit();				
		}
	</script>
	<div class="incontainer">
        ...
        <div class="cirborder-wrap online">
        	<div class="cirtit">
	        	<ul>
	        		<li>귀농귀촌과 관련 궁금하신 내용을 작성해 주시면 관련 전문가가 답변 드립니다. </li>
	                <li>『온라인 상담안내』 및 강원도 귀농귀촌 지원센터 모든 게시판은 실명제로 운영하고 있습니다.</li>
	                <li>게시판 취지에 맞지 않는 상업적 광고, 욕설 등의 글은 삭제됨을 알려드립니다.</li>
        ...
        <div class="basicboard-wrap">
            ...
            <div class="tr">
	        	<a href="javascript:onlineCounselAddGo();"  class="commonbtns black onebtn">글쓰기</a>
            </div>
            
            <form name="frm" action ="<c:url value='/site/counsel/onlineCounsel.do'/>" method="post" enctype="multipart/form-data">
