...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<script type="text/javascript">
		...
		function selectArticle(boardNo){
			...
			document.frm.action = "<c:url value='/site/comunity/gallery_view.do'/>";
			document.frm.submit();
		}
		function galleryAddGo(){
			document.frm.action = "<c:url value='/site/comunity/gallery_action.do?type=insert'/>";
			document.frm.submit();				
		}
	</script>
        ...
        <div class="basicboard-wrap">
            ...
            <div class="tr">
	            <c:if test="${sessionScope.loginVO.login_type eq 'admin' }">
    	            <a href="javascript:galleryAddGo();" class="commonbtns black onebtn">글쓰기</a>
        		</c:if>
            </div>
            
            <form name="frm" action ="<c:url value='/site/comunity/gallery.do'/>" method="post" enctype="multipart/form-data">
				<input type="hidden" id="boardNo" name="boardNo"/>
				<input type="hidden" name="boardCode" value="07"/>
