            ...
            for (i = 0; i < levelCnt; i++) { // iterate through all levels
                ...
                if (levelSegs) {
                    for (j = 0; j < levelSegs.length; j++) { // iterate through segments in level
                        ...
                        if (seg.leftCol != seg.rightCol) {
                         var $tdCol = td.attr("colspan"),
                         tdHtml = td.html();

                         for(var v = 0; v < $tdCol - 1; v++) {
                         td.attr("colspan", "");
                         td.after("<td class='fc-event-container'>"+ tdHtml +"</td>");
...
// Do these segments occupy the same vertical space?
    ...
    function Calendar_constructor(element, overrides) {
        ...
        function renderView(viewType, explicitScrollState) {
            ...
            function calViewinit() {
             calViewSet();

                function calViewSet() {
                    var $evtwrap;

                    $evtwrap = $(".fc-event-container");
                    $evtwrap.each(function(i,e) {
                        var $this = $(this);
                        var $evtidx = $this.index(),
                            $evttbl = $this.closest("table"),
                            $evtsametxt = $evttbl.find("thead td").eq($evtidx).data("date");

                        $this.append("<a href='#lnk' class='evtbtn'><span class='screen_out'>"+ $evtsametxt +"</span><span class='screen_out'>교육있음</span></a>");
                    });
                    $(".fc-h-event").hide();
                }
             }
