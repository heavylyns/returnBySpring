        ...
        if(item.getFieldName().equals("callback")) {
            ...
            if(item.getSize() > 0) {
                ...
                if(cnt == 0) {
                    ...
                    //파일 기본경로 _ 상세경로
                    String filePath = dftFilePath + "js" + File.separator +"smarteditor" + File.separator + "upladfiles" + File.separator;
                    ...
                    return3 += "&sFileURL=/js/smarteditor/uploadfiles/"+realFileNm;
                }
            }else {
